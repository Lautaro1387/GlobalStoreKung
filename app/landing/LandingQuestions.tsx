...
export default function LandingQuestions() {
  ...
  return(
        <div id='faqs' className="flex flex-col justify-center pb-30 md:text-center md:px-40 py-20">
        ...
        <div className="flex items-center border-b-2 w-full focus:outline-none cursor-pointer" onClick={handleClick3}>
          <h1 className='px-4 font-bold text-left text-lg w-full'>
            ¿Cuanto tiempo demoran en realizar mi proyecto?
          </h1>
          <Image src={imgEnable} alt="" width={50} height={10}/>
        </div>
        <p className={`px-4 py-2 pb-10 text-lg  md:text-left ${textEnable3}`}>Dependerá del tipo de servicio que eligas, pero siempre se indicará antes del pago, el tiempo previsto que llevará hacer el proyecto.</p>
